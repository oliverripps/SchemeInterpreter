...
(define primitive-operators '(+ - * / negate add1 sub1 list cons car cdr eqv? lt? gt? leq?))
...
(define (eval-exp tree e)
  (cond [(lit-exp? tree) (lit-exp-num tree)]
        ...
        [(let-exp? tree) (eval-exp (fourth tree) (env (second tree)
                                 ...
                                 e))]
        [(app-exp? tree) (apply-proc (app-exp-proc tree) (map (lambda (element) (eval-exp element e)) (car (app-exp-args tree))))]
